...
namespace Dungeon.Visual.UI.Inventory
{
    public class ItemDragManipulator : PointerManipulator
    {
        ...
        private void OnPointerDown(PointerDownEvent evt)
        {
           ...
           ShowGhost(_draggedItem.Data, evt.position);
        ...
        private InventorySlot FindSlotUnderPointer(Vector2 position)
       {
        ...
        private void OnPointerMove(PointerMoveEvent evt)
        {
           ...
           UpdateGhostPosition(evt.position);
            ...
            if (slotUnderPointer != _highlightedSlot)
            {
                ...
                {
                    bool valid = slotUnderPointer.CanAccept(_draggedItem.Data.Category);
                    slotUnderPointer.SetDropHighlight(true, valid);
        ...
        private void OnPointerUp(PointerUpEvent evt)
        {
           ...
           if (targetSlot != null && targetSlot != _sourceSlot && targetSlot.CanAccept(_draggedItem.Data.Category))
           {
